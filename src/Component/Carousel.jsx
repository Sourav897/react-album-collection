                  ...
                  >
                    {item.id === 1 && (
                      <img
                        height={"350px"}
                        width={"500px"}
                        src="https://media.istockphoto.com/id/933380632/vector/summer-beach-with-a-sun.webp?s=612x612&w=0&k=20&c=4zljbYXuRqIhRNPfgQot0HHggv00s3qPjgKpz2P7998="
                        alt="..."
                      />
                    )}
                    {item.id === 11 && (
                      <img
                        height={"350px"}
                        width={"500px"}
                        src="https://media.istockphoto.com/id/541851454/vector/poster-with-summer-elements.webp?s=612x612&w=0&k=20&c=oUjKEsntPLLLRggCzf9hI2c0WtLrCYTQPttjw9seBmA="
                        alt="..."
                      />
                    )}
                    {item.id === 21 && (
                      <img
                        height={"350px"}
                        width={"500px"}
                        src="https://static.vecteezy.com/system/resources/previews/000/203/124/non_2x/vector-abstract-landscape-illustration.jpg"
                        alt="..."
                      />
                    )}
                    {item.id === 31 && (
                      <img
                        height={"350px"}
                        width={"500px"}
                        src="https://th.bing.com/th/id/R.964b94b2822a8d1d7a1feaea04eac6eb?rik=Zt1WlJP5QdKjzg&riu=http%3a%2f%2fwallpaperswide.com%2fdownload%2flow_poly_river_landscape_design-wallpaper-800x480.jpg&ehk=A2lg53GkgOKLlq0JQuc1wvTr8hzXA6jejyy9hakzmAY%3d&risl=&pid=ImgRaw&r=0"
                        alt="..."
                      />
                    )}
                    {item.id === 41 && (
                    ...
                    {item.id === 51 && (
                      <img
                        height={"350px"}
                        width={"500px"}
                        src="https://th.bing.com/th/id/OIP.IVIFxarH16OZS9CsUdC_MAHaE7?pid=ImgDet&w=626&h=417&rs=1"
                        alt="..."
                      />
                    )}
                    {item.id === 61 && (
                      <img
                        height={"350px"}
                        width={"500px"}
                        src="https://static.vecteezy.com/system/resources/previews/000/226/163/non_2x/night-time-beach-vector.jpg"
                        alt="..."
                      />
                    )}
                    {item.id === 71 && (
                      <img
                        height={"350px"}
                        width={"500px"}
                        src="https://image.freepik.com/free-vector/tropical-palm-trees-birds-sunset_24640-65918.jpg"
                        alt="..."
                      />
                    )}
                    {item.id === 81 && (
                    ...
                    {item.id === 91 && (
                      <img
                        height={"350px"}
                        width={"500px"}
                        src="https://cdn.dribbble.com/users/876373/screenshots/2595382/attachments/516955/summer_sunset.jpg?compress=1&resize=600x450"
                        alt="..."
                      />
                    )}
                  ...
                  >
                    {item.id > 1 && item.id < 11 && (
                      <img
                        height={"350px"}
                        width={"500px"}
                        src="https://th.bing.com/th/id/OIP.kig9cukVC7I_GTI47D-vZwHaFL?pid=ImgDet&rs=1"
                        alt="..."
                      />
                    )}
                    {item.id > 11 && item.id < 21 && (
                      <img
                        height={"350px"}
                        width={"500px"}
                        src="https://static.vecteezy.com/system/resources/previews/000/201/504/large_2x/vector-beautiful-sunset-landscape-background.jpg"
                        alt="..."
                      />
                    )}
